...
![Fig](/network2_2.jpg "글로벌 네트워크 아키텍처")
...
### 일반적인 계층 구모(모듈화 설계의 좋은 예)

![Fig](/network2_3.jpg "일반적인 네트워크 구조")
...
![Fig](/network2_4.jpg "기업 LAN의 인터넷 구성도")
...
![Fig](/network2_5.jpg "블레이드 서버 구성도")
...
![Fig](/network2_6.jpg "클라우드 컴퓨팅 구성도")
